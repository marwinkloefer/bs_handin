...
impl Key {
    ...
    pub fn set_ascii(&mut self, a: u8) {
        self.asc = a;
    }
    pub fn set_scancode(&mut self, s: u8) {
        self.scan = s;
    }
    pub fn get_ascii(&mut self) -> u8 {
        return self.asc;
    }
    ...
    pub fn set_shift(&mut self, pressed: bool) {
        if pressed == true {
            self.modi = self.modi | KMOD_SHIFT;
        } else {
            self.modi = self.modi & !KMOD_SHIFT;
        }
    }
    ...
    pub fn set_alt_left(&mut self, pressed: bool) {
        if pressed == true {
            self.modi = self.modi | KMOD_ALT_LEFT;
        } else {
            self.modi = self.modi & !KMOD_ALT_LEFT;
        }
    }
    ...
    pub fn set_alt_right(&mut self, pressed: bool) {
        if pressed == true {
            self.modi = self.modi | KMOD_ALT_RIGHT;
        } else {
            self.modi = self.modi & !KMOD_ALT_RIGHT;
        }
    }
    ...
    pub fn set_ctrl_left(&mut self, pressed: bool) {
        if pressed == true {
            self.modi = self.modi | KMOD_CTRL_LEFT;
        } else {
            self.modi = self.modi & !KMOD_CTRL_LEFT;
        }
    }
    ...
    pub fn set_ctrl_right(&mut self, pressed: bool) {
        if pressed == true {
            self.modi = self.modi | KMOD_CTRL_RIGHT;
        } else {
            self.modi = self.modi & !KMOD_CTRL_RIGHT;
        }
    }
    ...
    pub fn set_caps_lock(&mut self, pressed: bool) {
        if pressed == true {
            self.modi = self.modi | KMOD_CAPS_LOCK;
        } else {
            self.modi = self.modi & !KMOD_CAPS_LOCK;
        }
    }
    ...
    pub fn set_num_lock(&mut self, pressed: bool) {
        if pressed == true {
            self.modi = self.modi | KMOD_NUM_LOCK;
        } else {
            self.modi = self.modi & !KMOD_NUM_LOCK;
        }
    }
    ...
    pub fn set_scroll_lock(&mut self, pressed: bool) {
        if pressed == true {
            self.modi = self.modi | KMOD_SCROLL_LOCK;
        } else {
            self.modi = self.modi & !KMOD_SCROLL_LOCK;
        }
    }
    ...
    pub fn get_shift(&self) -> bool {
        return (self.modi & KMOD_SHIFT) != 0;
    }
    pub fn get_alt_left(&self) -> bool {
        return (self.modi & KMOD_ALT_LEFT) != 0;
    }
    pub fn get_alt_right(&self) -> bool {
        return (self.modi & KMOD_ALT_RIGHT) != 0;
    }
    pub fn get_ctrl_left(&self) -> bool {
        return (self.modi & KMOD_CTRL_LEFT) != 0;
    }
    pub fn get_ctrl_right(&self) -> bool {
        return (self.modi & KMOD_CTRL_RIGHT) != 0;
    }
    pub fn get_caps_lock(&self) -> bool {
        return (self.modi & KMOD_CAPS_LOCK) != 0;
    }
    pub fn get_num_lock(&self) -> bool {
        return (self.modi & KMOD_NUM_LOCK) != 0;
    }
    pub fn get_scroll_lock(&self) -> bool {
        return (self.modi & KMOD_SCROLL_LOCK) != 0;
    }
